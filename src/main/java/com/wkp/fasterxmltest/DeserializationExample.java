...
public class DeserializationExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Company company = mapper.readValue(new File("/Users/wangkunpeng/Work/4study/misc-test8/src/main/resources/company_back.json"), Company.class);
        System.out.print("company_name:" + company.getName() + "\t");
        System.out.print("headquarters:" + company.getHeadquarters() + "\t");

        //birthDate被标记为@JsonIgnore，所以此处得到的值应该为null
        System.out.println("birthDate:" + company.getBirthDate());
